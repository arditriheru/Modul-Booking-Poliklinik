                                                            ...
                                                            <table class="table table-bordered table-hover table-striped tablesorter">
                                                              ...
                                                              <tbody>
                                                                <?php 
                                                                  ...
                                                                  ?>
                                                                  <tr>
                                                                    <td><center><?php echo $d['id_catatan_medik']; ?>
                                                                    </td>
                                                                    <td><center><?php echo $d['nama']; ?>
                                                                    </td>
                                                                    <td><center><?php echo $d['kontak']; ?>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                      <div align="center"><a href="tumbang-detail?id_tumbang=<?php echo $d['id_tumbang']; ?>"<button type="button" class="btn btn-warning">Detail</a><br><br>
                                                                      </div>
                                                                    </td>
                                                                    </tr><?php } ?>
                                                                  </tbody>
